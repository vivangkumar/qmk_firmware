...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_ESC,  _______, KC_MINUS,KC_PLS,  KC_EQL,  _______, _______, KC_LPRN, KC_RPRN, KC_USC,  KC_CLN,  KC_PIPE, \
  _______, _______, KC_AMP,  KC_AST,  KC_TLD,  _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______, \
  _______, _______, KC_GBP,  KC_DOL,  KC_HSH,  _______, _______, _______, _______, _______, _______, _______, \
